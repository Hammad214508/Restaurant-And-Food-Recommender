  ...
  <div class="container-fluid">
    ...
    <div id="main-menu" class="collapse navbar-collapse">
        ...
        <ul class="nav navbar-nav">
            <li id="nav-usr-portal" class="nav-item"><a id="user_name" class="nav-link" href="<?php global $basedir; ?>/Restaurant-And-Food-Recommender/UserPortal/Connections"> <?php echo $_SESSION["logged_in"][0][0]["NAME"] ." ".$_SESSION["logged_in"][0][0]["SURNAME"] ;?> </a></li>
