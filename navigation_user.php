  ...
  <div class="container-fluid">
    ...
    <div id="main-menu" class="collapse navbar-collapse">
        ...
        <ul class="nav navbar-nav">
            ...
            <li id="nav-restaurants" class="nav-item"><a class="nav-link" href="<?php global $basedir; ?>/Restaurant-And-Food-Recommender/UserPortal/"> Restaurants </a></li>
            <li id="nav-food-items" class="nav-item"><a class="nav-link" href="<?php global $basedir; ?>/Restaurant-And-Food-Recommender/UserPortal/"> Food Items </a></li>
            <li id="nav-recommendation" class="nav-item"><a class="nav-link" href="<?php global $basedir; ?>/Restaurant-And-Food-Recommender/UserPortal/Recommender/recommended.php"> Recommended </a></li>
