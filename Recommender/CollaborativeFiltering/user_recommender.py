...
# Gets the recommendations for the user using a user-based recommendation with
# cosine similarity, this is used in the front page
...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
# Get the food items available for the item based recommendations, it
# requires the images as well
...
# Perform the item based recommendation system
...
# This function is to get restaurant recommendations for a single user based on the
# top items in that restaurant and the filters provided
